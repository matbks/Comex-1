		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Comex App",
									"targetURL": "#comexzcomexapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexzcomexapp-display": {
								"semanticObject": "comexzcomexapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=comex.zcomexapp",
									"url": sap.ui.require.toUrl("comex/zcomexapp")
								}
							}
						}
					}
