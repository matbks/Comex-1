sap.ui.define([
    ...
    return BaseController.extend("comex.zcomexapp.controller.List", {
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("Invoice", FilterOperator.Contains, sQuery)];
            } else {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "comex.zcomexapp.view.ViewSettingsDialog",
                    controller: this
